                ...
                <Container maxWidth="md">
                    <div style={{borderBottom:'1px solid #CECECE', paddingBottom:'40px', marginBottom:'40px', display:'flex', justifyContent:'space-between'}}>
                        ...
                        <div style={{display:'flex', alignItems:'center'}}>
                            ...
                            <input name="goalFundraising" onChange={FormValueHandler} style={{border:'1px solid #B6B7B9', borderRadius:'3px', width:'150px', height:'40px', marginRight:'5px'}} placeholder={'목표 금액을 입력해주세요'}></input>
