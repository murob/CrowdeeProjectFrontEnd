                    ...
                    <div style={{marginTop:'100px'}}>
                        ...
                        <div style={{display:'flex', justifyContent:'space-evenly', marginLeft:'-50px'}}>
                            <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                                <Button onClick={()=>buttonClick("/category/:ballet")}><Avatar alt="Remy Sharp" src={require('./dancing.png').default} style={{width:"150px",height:"150px"}} /></Button>
                            ...
                            <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                                <Button onClick={()=>buttonClick("/category/:concert")}><Avatar alt="Remy Sharp" src={require('./musical.png').default} style={{width:"150px",height:"150px"}} /></Button>
                                <h4 style={{fontWeight:'bold'}}>뮤지컬</h4>
                            </div>
                            <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                                <Button onClick={()=>buttonClick("/category/:piano")}><Avatar alt="Remy Sharp" src={require('./concert.png').default} style={{width:"150px",height:"150px"}} /></Button>
